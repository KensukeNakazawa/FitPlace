...
class ExerciseTypeServiceTest extends TestCase
{
    ...
    {
        $this->exerciseTypeServise = $this->app->make('Domain\ApplicationServices\Exercise\ExerciseTypeService');
    ...
    public function testAddExerciseType()
    {
        ...
        $this->exerciseService = $this->app->make('Domain\ApplicationServices\Exercise\ExerciseTypeService');
